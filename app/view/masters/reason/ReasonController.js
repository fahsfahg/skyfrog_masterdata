Ext.define('skyfrog.view.masters.reason.ReasonController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.masters-reason-reason',

    requires: [
        "skyfrog.view.masters.reason.ReasonForm",
        "Ext.window.Window",
    ],
    ...
    createDialog: function (record) {
        ...
        this.dialog = view.add({
          ...
          viewModel: {
            data: {
              title: record ? "Edit : " + record.get("reason") : "Add Reason",
            },
          },
          record,
      ...
      beforeDetailRender: function (view) {
        if (view.record) {
          var record = view.record ? view.record : {};
            ...
            view.down("#reasonname").setValue(record.get("reason")),
