Ext.define('skyfrog.view.masters.expense.ExpenseController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.masters-expense-expense',

    requires: [
        "skyfrog.view.masters.expense.ExpenseForm",
        "Ext.window.Window",
    ],
    ...
    createDialog: function (record) {
        ...
        this.dialog = view.add({
          ...
          viewModel: {
            data: {
              title: record ? "Edit : " + record.get("name") : "Add Expense",
            },
          },
          record,
      ...
      beforeDetailRender: function (view) {
        if (view.record) {
          var record = view.record ? view.record : {};
            ...
            view.down("#expensename").setValue(record.get("name"))
        }
      },
