Ext.define('skyfrog.view.masters.skillmaster.SkillMasterController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.masters-skillmaster-skillmaster',

    requires: [
        "skyfrog.view.masters.skillmaster.SkillMasterForm",
        "Ext.window.Window",
    ],
    ...
    createDialog: function (record) {
        ...
        this.dialog = view.add({
          ...
          viewModel: {
            data: {
              title: record ? "Form Skill Master" : "Form Skill Master",
            },
          },
          record,
      ...
      beforeDetailRender: function (view) {
        if (view.record) {
          var record = view.record ? view.record : {};
            ...
            view.down("#skillcode").setValue(record.get("skillcode")),
